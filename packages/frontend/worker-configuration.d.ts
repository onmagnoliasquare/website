/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 02d5a8bd036a566cbef8954190b7cc0e)
...
interface __BaseEnv_Env {
	...
	SECRET_SANITY_DEVELOPER_TOKEN: string;
	SECRET_CLOUDFLARE_PREVIEW_TOKEN: string;
	CI: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SANITY_PROJECT_ID" | "SANITY_DATASET" | "SANITY_API_VERSION" | "SECRET_SANITY_DEVELOPER_TOKEN" | "SECRET_CLOUDFLARE_PREVIEW_TOKEN" | "CI">> {}
}
